...
class BaseModel:
	...
	def save(self, sess):
		print("Saving model...")
		self.saver.save(sess, self.config['checkpoint'], self.global_step_tensor)  # noteasydict, checkpoint_dir
		print("Model saved")

	# load latest checkpoint from the experiment path defined in the config file
	def load(self, sess):
		latest_checkpoint = tf.train.latest_checkpoint(self.config['checkpoint'])  # noteasydict, checkpoint_dir
